package com.justkeepfaith.haitamblein;
...
public class registrare extends AppCompatActivity {
    ...
    private void checker(){
        ...
        androidx.appcompat.app.AlertDialog.Builder dialog = new androidx.appcompat.app.AlertDialog.Builder(registrare.this);
        ...
        dialog.setPositiveButton("Proceed", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                progressDialog = new ProgressDialog(registrare.this);
                ...
                new Thread(new Runnable() {
                    public void run() {
                        try {
                            Thread.sleep(8000);
                            Intent intent = new Intent(registrare.this, accesso.class);
